...
public class ArithmeticMeanForecastTest {
    ...
    private final Map<LocalDate, Double> forecastData = new TreeMap<>();
    ...
    public void testGetForecast() {
        ...
        Map<LocalDate, Double> actualFirst = strategy.getForecast(forecastData, "tomorrow");
        ...
        Map<LocalDate, Double> actualSecond = strategy.getForecast(forecastData, "week");
